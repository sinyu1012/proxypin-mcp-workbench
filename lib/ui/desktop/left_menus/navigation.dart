...
class _LeftNavigationBarState extends State<LeftNavigationBar> {
  ...
  List<NavigationRailDestination> get destinations => [
        ...
        NavigationRailDestination(
            ...
            label: Text('工作台', style: Theme.of(context).textTheme.bodySmall)),
        NavigationRailDestination(
            padding: const EdgeInsets.only(bottom: 5),
        ...
        builder: (_, index, __) {
          ...
          return Container(
            ...
            child: Column(children: <Widget>[
              Expanded(child: leftNavigation(index)),
              SafeArea(
                  top: false,
                  child: Column(
                          ...
                          child: IconButton(
                              ...
                              onPressed: () {
                                showDialog(
                                    context: context,
                                    builder: (_) =>
                                        Preference(widget.appConfiguration, widget.proxyServer.configuration));
                              },
